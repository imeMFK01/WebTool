...
namespace PerceptronXfmsAPI.Models
{
    public class ProteinDtoOld
    {
        ...
        public ProteinDtoOld(ProteinDtoOld Protein)
        {

        }

        public ProteinDtoOld(string cFileName, string cHeader, string cTerminalModification, string cSequence, string cTruncationSite, int cTruncationIndex, double cScore,
