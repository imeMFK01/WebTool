...
static const char *__pyx_f[] = {
  "MDAnalysis\\coordinates\\timestep.pyx",
  "MDAnalysis\\coordinates\\timestep.pxd",
  "stringsource",
  "__init__.pxd",
  "type.pxd",
};
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(PyDict_CheckExact(__pyx_t_1))||((__pyx_t_1) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "dict", Py_TYPE(__pyx_t_1)->tp_name), 0))) __PYX_ERR(0, 830, __pyx_L1_error)
  __Pyx_GIVEREF(__pyx_t_1);
  __Pyx_GOTREF(__pyx_v_self->data);
  __Pyx_DECREF(__pyx_v_self->data);
...
static int __pyx_pf_10MDAnalysis_11coordinates_8timestep_8Timestep_4data_2__set__(struct __pyx_obj_10MDAnalysis_11coordinates_8timestep_Timestep *__pyx_v_self, PyObject *__pyx_v_value) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__set__", 0);
  if (!(likely(PyDict_CheckExact(__pyx_v_value))||((__pyx_v_value) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "dict", Py_TYPE(__pyx_v_value)->tp_name), 0))) __PYX_ERR(1, 44, __pyx_L1_error)
  __pyx_t_1 = __pyx_v_value;
  __Pyx_INCREF(__pyx_t_1);
  __Pyx_GIVEREF(__pyx_t_1);
  __Pyx_GOTREF(__pyx_v_self->data);
