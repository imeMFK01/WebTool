function InputFilesData = ValidationsAndInputFilesInfo(QueryFullFolderPath, DoseResponseFile, InsideExp, RepArr)
...
InputFilesData = [InputFilesData; InputFilesInfo];
