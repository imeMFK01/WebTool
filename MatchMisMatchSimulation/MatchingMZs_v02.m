    ...
    for j=1:sizeOfMassHunterData
        ...
        if AbsMatchDiff <= MatchTolerance  %Match
            ...
            if ~MzAdded      %% Only for formatting
                MzAdded = true;
                DataResultSheet1 = [DataResultSheet1; sortMascotData(i,1), MatchDiff, sortMassHunterData(j,4)];
            else
                DataResultSheet1 = [DataResultSheet1; "", MatchDiff, sortMassHunterData(j,4)];
            end
